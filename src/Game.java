abstract class Game {
    //ein Feld vom Typ Player
    // und eine Variable vom Typ GameBoard an.
    // Für beide Instanzvariablen soll ein Zugriff aus einer abgeleiteten Klasse möglich sein.

    // Implementieren Sie einen Konstruktor, der zwei Strings mit den Namen der Mitspielenden
    // erhält und die beiden Instanzvariablen geeignet initialisiert.

    // drei abstrakte Methoden deklariert werden.
    //Die Methode play hat keine Parameter und keinen Rückgabewert,
    // ebenso auch die Methode printBoard, die allerdings eine Exception vom Typ GameException auswirft.
    // Die Methode printWinner hat keinen Rückgabewert und einen Parameter vom Typ Player.


        public class ConsoleGame{
            //Spielablauf für eine Konsolenein- und -ausgabe
        }
